...
public class ProfileActivity extends AppCompatActivity {
    ...
    // private PieChart accuracyChart; // Temporarily commented out
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupClickListeners();
        populateUserData();
        // setupAccuracyChart(); // Temporarily commented out
    }
    ...
    private void initializeViews() {
        ...
        // accuracyChart = findViewById(R.id.accuracy_chart); // Temporarily commented out
    ...
    private void populateUserData() {
        ...
        android.util.Log.d("ProfileActivity", "User Statistics - Total: " + currentUser.getTotalQuestions() 
            + ", Correct: " + currentUser.getCorrectAnswers() 
            + ", Incorrect: " + currentUser.getIncorrectAnswers()
            + ", Completed Quizzes: " + (currentUser.getCompletedQuizIds() != null ? currentUser.getCompletedQuizIds().size() : 0));
        ...
        // Show debug info if statistics are zero
        if (currentUser.getTotalQuestions() == 0) {
            Toast.makeText(this, "No quiz statistics yet. Complete a quiz to see your progress!", Toast.LENGTH_LONG).show();
        }
